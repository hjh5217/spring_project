...
public class Collection_main {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println(arr1); HashSet ss1 = context.getBean("ss1",HashSet.class);
		 * System.out.println(ss1); LinkedHashSet ss2 =
		 * context.getBean("ss2",LinkedHashSet.class); System.out.println(ss2); HashMap
		 * map1 = context.getBean("map1",HashMap.class); System.out.println(map1);
		 */
