...
public class AutoCar {
	...
	//매개변수로 받을 대 에러가 발생되는 경우에는 작동되지 않는다.
	public AutoCar(AutoEngine eng, List<AutoWheel> whs, AutoHandle hjhkh) {
		super();
		this.eng = eng;
		this.whs = whs;
		this.handle = hjhkh;
	...
	// 매개변수가 모두 충족할 경우 매개변수가 많은 생성자로 생성
	// 매개변수 할당 우선순위
	// 1.byName
	// 2.byType
	...
	public void setWhsqwer(List<AutoWheel> whs) {
		this.whs = whs;
	}
